...
var PhysicsEngine = (function () {
  ...
  function init() {
    ...
    engine = Engine.create({
      ...
      positionIterations: 6,  // Lower iterations for instant, crisp bounces (higher = softer/delayed)
      velocityIterations: 4   // Lower iterations for instant response
    });
    ...
    Events.on(engine, "afterUpdate", function () {
      ...
      balls.forEach(function (ball) {
        ...
        // Cap maximum velocity to prevent wall tunneling
        // Higher cap in zero-gravity for better perpetual motion
        var maxSpeed = mode.enableThreshold ? 20 : 30;
        if (speed > maxSpeed) {
