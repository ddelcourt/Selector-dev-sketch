...
(function() {
  ...
  function resetToDefaults() {
    ...
    document.getElementById('whiteText').checked = defaults.whiteText;
    document.getElementById('enableWindowShake').checked = defaults.enableWindowShake;
    document.getElementById('enablePulseEffect').checked = defaults.enablePulseEffect;
    document.getElementById('randomTopBottom').checked = defaults.randomTopBottom;
