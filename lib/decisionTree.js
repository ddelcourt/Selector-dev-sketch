  ...
  function initializeUI(tree) {
        ...
        if (kids.length > 0 && !hasOnlyEndChild) {
          ...
          if (physicsMode && typeof PhysicsEngine !== "undefined") {
            ...
            setTimeout(function() {
              ...
              console.log("Zero gravity + zero friction + perfect elasticity + random velocities = perpetual motion!");
            }, 6000);
          }
        }
      } catch (error) {
    ...
    $("#back").on("click", function (e) {
      ...
      if (physicsMode && typeof PhysicsEngine !== "undefined") {
        ...
        console.log("Gravity, friction, and bounciness reset to normal");
      }
